...
%    linewidth: the width of the lines the bars are made of (default is 1)
...
%    colormap: in the case that multicolor is specified, one may also specify a particular colormap to
...
if ~fillFlag % plot errobars normally.
    ...
    %Plot the mean:
    plot(x,y,'linewidth',1,'color',color2Plot);
    %Make the polygon:
